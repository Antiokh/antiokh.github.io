...
class MatrixRain {
	constructor(element, width, height, charList, red, green, blue, randomColors, flowRate, fps, font) {
		this.font = font;
		this.canvas = element;
