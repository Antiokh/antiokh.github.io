const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.BMwecOfQ.js","assets/chunks/framework.CTBQRFhE.js"])))=>i.map(i=>d[i]);
import { d as defineComponent, c as createElementBlock, r as renderSlot, n as normalizeClass, o as openBlock, a as createTextVNode, t as toDisplayString, b as createBlock, w as withCtx, T as Transition, e as createCommentVNode, _ as _export_sfc, u as useData$1, i as isExternal, f as treatAsHtml, g as withBase, h as computed, j as createBaseVNode, k as unref, l as isActive, m as useMediaQuery, p as ref, q as watch, s as watchEffect, v as onMounted, x as onUnmounted, y as watchPostEffect, z as onUpdated, A as getScrollOffset, F as Fragment, B as renderList, C as resolveComponent, D as onContentUpdated, E as createVNode, G as shallowRef, H as resolveDynamicComponent, I as EXTERNAL_URL_RE, J as useRoute, K as mergeProps, L as inject, M as useWindowSize, N as normalizeStyle, O as onKeyStroke, P as nextTick, Q as useWindowScroll, R as inBrowser, S as readonly, U as defineAsyncComponent, V as __vitePreload, W as useScrollLock, X as provide, Y as toHandlers, Z as withKeys, $ as onBeforeUnmount, a0 as withModifiers, a1 as useSlots, a2 as withDirectives, a3 as vModelText, a4 as reactive } from "./framework.CTBQRFhE.js";
...
const _sfc_main$k = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.BMwecOfQ.js"), true ? __vite__mapDeps([0,1]) : void 0));
...
const _hoisted_1 = { class: "uplatnica-widget" };
const _hoisted_2 = { class: "uplatnica-controls" };
const _hoisted_3 = { class: "uplatnica-grid" };
const _hoisted_4 = { class: "uplatnica-actions" };
const _hoisted_5 = {
  class: "uplatnica-slip",
  "aria-label": "Предпросмотр платёжки"
};
const _hoisted_6 = { class: "uplatnica-slip-body" };
const _hoisted_7 = ["src"];
const _sfc_main = {
  __name: "UplatnicaGenerator",
  setup(__props) {
    const defaults = {
      payer: "Иван Иванов\nБулевар краља Александра 1\n11000 Београд",
      recipient: "Министарство унутрашњих послова\nБулевар Михајла Пупина 2\n11070 Нови Београд",
      purpose: "Републичка административна такса",
      amount: "1950.00",
      account: "840-742221843-57",
      model: "97",
      reference: "50-016",
      paymentCode: "153",
      currency: "RSD"
    ...
    const qrPayload = computed(() => [
      ...
      "C:1",
      `R:${form.account}`,
      `N:${form.recipient.replace(/\n/g, " ")}`,
      `I:${form.currency}${form.amount.replace(".", ",")}`,
      `P:${form.payer.replace(/\n/g, " ")}`,
      `SF:${form.paymentCode}`,
      `S:${form.purpose}`,
      `RO:${form.model}${form.reference}`
    ].join("|"));
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("form", _hoisted_2, [
          createBaseVNode("label", null, [
            _cache[10] || (_cache[10] = createTextVNode(" Плательщик ", -1)),
            withDirectives(createBaseVNode("textarea", {
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => form.payer = $event),
              rows: "3"
            }, null, 512), [
              [vModelText, form.payer]
            ])
          ]),
          createBaseVNode("label", null, [
            _cache[11] || (_cache[11] = createTextVNode(" Получатель ", -1)),
            withDirectives(createBaseVNode("textarea", {
              "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => form.recipient = $event),
              rows: "3"
            }, null, 512), [
              [vModelText, form.recipient]
            ])
          ]),
          createBaseVNode("label", null, [
            _cache[12] || (_cache[12] = createTextVNode(" Назначение платежа ", -1)),
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => form.purpose = $event)
            }, null, 512), [
          ...
          createBaseVNode("div", _hoisted_3, [
            createBaseVNode("label", null, [
              _cache[13] || (_cache[13] = createTextVNode(" Сумма, RSD ", -1)),
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => form.amount = $event),
                inputmode: "decimal"
              }, null, 512), [
                [vModelText, form.amount]
              ])
            ]),
            createBaseVNode("label", null, [
              _cache[14] || (_cache[14] = createTextVNode(" Счет получателя ", -1)),
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => form.account = $event)
              }, null, 512), [
                [vModelText, form.account]
              ])
            ]),
            createBaseVNode("label", null, [
              _cache[15] || (_cache[15] = createTextVNode(" Модель ", -1)),
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => form.model = $event)
              }, null, 512), [
                [vModelText, form.model]
              ])
            ]),
            createBaseVNode("label", null, [
              _cache[16] || (_cache[16] = createTextVNode(" Позив на број ", -1)),
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => form.reference = $event)
              }, null, 512), [
                [vModelText, form.reference]
              ])
            ]),
            createBaseVNode("label", null, [
              _cache[17] || (_cache[17] = createTextVNode(" Шифра плаћања ", -1)),
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => form.paymentCode = $event)
              }, null, 512), [
                [vModelText, form.paymentCode]
              ])
            ]),
            createBaseVNode("label", null, [
              _cache[18] || (_cache[18] = createTextVNode(" Валюта ", -1)),
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => form.currency = $event)
              }, null, 512), [
                [vModelText, form.currency]
              ])
            ])
          ]),
          createBaseVNode("div", _hoisted_4, [
            createBaseVNode("button", {
              type: "button",
              onClick: _cache[9] || (_cache[9] = ($event) => _ctx.window.print())
            }, "Печать"),
            createBaseVNode("button", {
              type: "button",
              onClick: reset
        ...
        createBaseVNode("section", _hoisted_5, [
          _cache[26] || (_cache[26] = createBaseVNode("div", { class: "uplatnica-slip-head" }, [
            createBaseVNode("strong", null, "Налог за уплату"),
            createBaseVNode("span", null, "пример для теста компонента")
          ], -1)),
          createBaseVNode("div", _hoisted_6, [
            createBaseVNode("div", null, [
              _cache[19] || (_cache[19] = createBaseVNode("span", null, "уплатилац", -1)),
              createBaseVNode("strong", null, toDisplayString(form.payer), 1)
            ]),
            createBaseVNode("div", null, [
              _cache[20] || (_cache[20] = createBaseVNode("span", null, "сврха уплате", -1)),
              createBaseVNode("strong", null, toDisplayString(form.purpose), 1)
            ]),
            createBaseVNode("div", null, [
              _cache[21] || (_cache[21] = createBaseVNode("span", null, "прималац", -1)),
              createBaseVNode("strong", null, toDisplayString(form.recipient), 1)
            ]),
            createBaseVNode("div", null, [
              _cache[22] || (_cache[22] = createBaseVNode("span", null, "износ", -1)),
              createBaseVNode("strong", null, toDisplayString(form.currency) + " " + toDisplayString(form.amount), 1)
            ]),
            createBaseVNode("div", null, [
              _cache[23] || (_cache[23] = createBaseVNode("span", null, "рачун примаоца", -1)),
              createBaseVNode("strong", null, toDisplayString(form.account), 1)
            ]),
            createBaseVNode("div", null, [
              _cache[24] || (_cache[24] = createBaseVNode("span", null, "модел и позив на број", -1)),
              createBaseVNode("strong", null, toDisplayString(form.model) + " " + toDisplayString(form.reference), 1)
            ]),
            createBaseVNode("div", null, [
              _cache[25] || (_cache[25] = createBaseVNode("span", null, "шифра плаћања", -1)),
              createBaseVNode("strong", null, toDisplayString(form.paymentCode), 1)
            ]),
            createBaseVNode("img", {
              src: qrUrl.value,
              alt: "QR код платёжки"
